...
const STATS_DIR = 'C:/proj/.pipeline/.stats';
...
describe('stats helpers', () => {
  test('statsDirForJournal derives the sibling .stats dir from the journal path', () => {
    expect(statsDirForJournal('C:/proj/.pipeline/.runtime/events.jsonl').replace(/\\/g, '/')).toBe(
      'C:/proj/.pipeline/.stats'
    );
    expect(statsDirForJournal('/home/u/p/.pipeline/.runtime/events.jsonl').replace(/\\/g, '/')).toBe(
      '/home/u/p/.pipeline/.stats'
    );
  });
